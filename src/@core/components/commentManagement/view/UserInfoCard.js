...
// ** Custom Components
import avatarImg from '../../../assets/images/avatar-s-11.jpg'
          ...
          <div className='info-container'>
            {selectedUser !== null ? (
              <ul className='list-unstyled'>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>نام و نام نام خانوادگی:</span>
                  <span>محسن مرتضی زاده</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>ایمیل:</span>
                  <span>mohsen@gmail.com</span>
                </li>
                <li className='mb-75'>
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            <Row className='gy-1 pt-75'>
              ...
              <Col md={6} xs={12}>
                ...
                <Input id='contact' defaultValue='09112456874' placeholder='+1 609 933 4422' />
              </Col>
              {/* <Col md={6} xs={12}>
